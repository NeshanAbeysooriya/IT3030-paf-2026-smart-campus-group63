  ...
  return (
    <header className="fixed top-0 w-full z-50 bg-white/30 backdrop-blur-xl border-b border-white/20 transition-all duration-300">
      <div className="max-w-[95%] mx-auto px-6 h-24 flex items-center justify-between">
        ...
        {/* 1. Logo */}
        <Link to="/home" className="flex items-center gap-5 shrink-0 group">
        ...
        {/* 2. Navigation & Search */}
        <div className="flex-grow flex items-center justify-center gap-x-12 px-12">
          ...
          <div className="hidden md:flex flex-grow max-w-lg relative group">
            ...
            <input
              ...
              className="w-full pl-11 pr-4 py-3 bg-white/50 border border-slate-200/60 rounded-2xl text-sm focus:bg-white focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 outline-none transition-all placeholder:text-slate-400 shadow-sm"
            />
          </div>
        </div>
        ...
        <div className="flex items-center gap-6 shrink-0">
          <button className="relative p-2.5 text-slate-500 hover:text-indigo-600 hover:bg-white/50 rounded-full transition-all">
